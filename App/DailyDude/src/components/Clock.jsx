...
const Clock = () => {
  ...
  const [alarmSound] = useState(new Audio('../public/sound/Alarm.wav')); // Add your alarm sound file
  const [timerSound] = useState(new Audio('../public/sound/Beep.wav')); // Add your timer sound file
